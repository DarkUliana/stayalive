...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Event-islands</div>
                    <div class="card-body">
                        <a href="{{ url('/event-islands/create') }}" class="btn btn-success btn-sm" title="Add New event-island">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        <form method="GET" action="{{ url('/event-islands') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>LocationName</th><th>FrequencyOfOccurrence</th><th>Lifetime</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($eventIslands as $item)
                                    <tr>
                            ...
                            <div class="pagination-wrapper"> {!! $eventIslands->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
