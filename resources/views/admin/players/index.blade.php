                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Name</th><th>GoogleID</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($players as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->Name }}</td><td>{{ $item->googleID }}</td>
                                        <td>
                                            ...
                                            <form method="POST" action="{{ url('/players' . '/' . $item->googleID) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
