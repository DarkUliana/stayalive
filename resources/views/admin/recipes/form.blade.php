<div class="form-group">
    ...
    <div class="col-md-6">
        <select id="item" name="itemID">
            ...
            <option value="{{$item->ID}}" @if(isset($recipe) && $item->ID == $recipe->ItemID) selected="selected" @endif>
                {{$item->Name}}
            </option>
            @endforeach
        </select>
...
</div><div class="form-group {{ $errors->has('recipeType') ? 'has-error' : ''}}">
    <label for="recipeType" class="col-md-4 control-label">{{ 'Recipetype' }}</label>
    <div class="col-md-6">
        <input class="form-control" name="recipeType" type="number" id="recipeType" value="{{ $recipe->recipeType or ''}}" >
        {!! $errors->first('recipeType', '<p class="help-block">:message</p>') !!}
    </div>
</div><div class="form-group {{ $errors->has('CraftTime') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('tmpComponentsSize') ? 'has-error' : ''}}">
    <label for="tmpComponentsSize" class="col-md-4 control-label">{{ 'Tmpcomponentssize' }}</label>
    <div class="col-md-6">
        <input class="form-control" name="tmpComponentsSize" type="number" id="tmpComponentsSize" value="{{ $recipe->tmpComponentsSize or ''}}" >
        {!! $errors->first('tmpComponentsSize', '<p class="help-block">:message</p>') !!}
    </div>
</div><div class="form-group {{ $errors->has('componentsSize') ? 'has-error' : ''}}">
    <label for="componentsSize" class="col-md-4 control-label">{{ 'Componentssize' }}</label>
    <div class="col-md-6">
        <input class="form-control" name="componentsSize" type="number" id="componentsSize" value="{{ $recipe->componentsSize or ''}}" >
        {!! $errors->first('componentsSize', '<p class="help-block">:message</p>') !!}
    </div>
</div><div class="form-group {{ $errors->has('tmpBuildingsSize') ? 'has-error' : ''}}">
    <label for="tmpBuildingsSize" class="col-md-4 control-label">{{ 'Tmpbuildingssize' }}</label>
    <div class="col-md-6">
        <input class="form-control" name="tmpBuildingsSize" type="number" id="tmpBuildingsSize" value="{{ $recipe->tmpBuildingsSize or ''}}" >
        {!! $errors->first('tmpBuildingsSize', '<p class="help-block">:message</p>') !!}
    </div>
</div><div class="form-group {{ $errors->has('BuildingsSize') ? 'has-error' : ''}}">
    <label for="BuildingsSize" class="col-md-4 control-label">{{ 'Buildingssize' }}</label>
    <div class="col-md-6">
        <input class="form-control" name="BuildingsSize" type="number" id="BuildingsSize" value="{{ $recipe->BuildingsSize or ''}}" >
...
</div><div class="form-group {{ $errors->has('InStack') ? 'has-error' : ''}}">
...
<div class="form-group">
    ...
    <div class="col-md-6">
        <select id="technologies" name="technologies[]" multiple="multiple">
            ...
            <option value="{{$technology->ID}}" @if(isset($selectedTechnologies) && in_array($technology->ID, $selectedTechnologies))selected="selected"@endif>
                {{$technology->name}}
            </option>
            @endforeach
        </select>
